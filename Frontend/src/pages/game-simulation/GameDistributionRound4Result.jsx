...
const GameDistributionRound4Result = () => {
  ...
  const monthlyDataRows = productRows.map(p => {
    ...
    // If no purchase this round, fall back to last round's (R3) unit price
    const r3UnitPrice = parseInt(localStorage.getItem(`gameDistributionR3UnitPrice_${p.key}`) || '0', 10);
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
              {[
                ...
                { label: "Net Distributor Rupee Gross Margin", value: formatCurrency(Math.round(netMargin)) },
