...
const GameDistributionRound6Result = () => {
  ...
  const newRetailerEffort = parseInt(localStorage.getItem("gameDistributionR6NewRetailerEffort") || "1", 10);
  const creditEnforcement = parseInt(localStorage.getItem("gameDistributionR6CreditEnforcement") || "1", 10);
  const quantityDiscount = parseFloat(localStorage.getItem("gameDistributionR6QuantityDiscount") || "0");
  const retailDisplay = parseFloat(localStorage.getItem("gameDistributionR6RetailDisplay") || "0");
